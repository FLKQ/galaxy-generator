...
const generateGalaxy = () =>
{
    ...
    const colorOuside = new THREE.Color(parameters.outsideColor )
    ...
    for(let i = 0; i < parameters.count; i++){
        ...
        mixedColor.lerp(colorOuside,radius / parameters.radius)
...
gui.add(parameters, 'randomnessPower', 1, 10 , 0.001)
